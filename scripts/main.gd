...
## Phases: menu, salvage, workshop, hall, battle, results, upgrade, win_lose

const PHASE_SCRIPTS := {
	"menu":     preload("res://scripts/phases/main_menu.gd"),
	"salvage":  preload("res://scripts/phases/salvage_pit.gd"),
	"workshop": preload("res://scripts/phases/workshop.gd"),
	"hall":     preload("res://scripts/phases/entrance_hall.gd"),
